...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php dsm($node);?>
    ...
    <?php
      ...
      hide($content['field_r10']);
      hide($content['field_r11']);
      hide($content['field_r12']);
      hide($content['field_r13']);
      hide($content['field_r14']);
      hide($content['field_a01']);
      hide($content['field_a02']);
      hide($content['field_a03']);
      hide($content['field_a04']);
      hide($content['field_a05']);
      hide($content['field_a06']);
      hide($content['field_a07']);
      hide($content['field_a08']);
      hide($content['field_a09']);
      hide($content['field_a10']);
      hide($content['field_a11']);
      hide($content['field_a12']);
      hide($content['field_a13']);
      hide($content['field_a14']);
      hide($content['field_s01']);
      hide($content['field_s02']);
      hide($content['field_s03']);
      hide($content['field_s04']);
      hide($content['field_s05']);
      hide($content['field_s06']);
      hide($content['field_s07']);
      hide($content['field_s08']);
      hide($content['field_s09']);
      hide($content['field_s10']);
      hide($content['field_s11']);
      hide($content['field_s12']);
      hide($content['field_s13']);
      hide($content['field_s14']);
      hide($content['field_t01']);
      hide($content['field_t02']);
      hide($content['field_t03']);
      hide($content['field_t04']);
      hide($content['field_t05']);
      hide($content['field_t06']);
      hide($content['field_t07']);
      hide($content['field_t08']);
      hide($content['field_t09']);
      hide($content['field_t10']);
      hide($content['field_t11']);
  ...
  <table summary="@todo - put in summary" id="grant-table">
    ...
    <tbody>
      ...
      <tr>
      <tr>
        <td><?php print render($content['field_grant02_ref']); ?></td>
        <td><?php print render($content['field_grant02_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant03_ref']); ?></td>
        <td><?php print render($content['field_grant03_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant04_ref']); ?></td>
        <td><?php print render($content['field_grant04_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant05_ref']); ?></td>
        <td><?php print render($content['field_grant05_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant06_ref']); ?></td>
        <td><?php print render($content['field_grant06_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant07_ref']); ?></td>
        <td><?php print render($content['field_grant07_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant08_ref']); ?></td>
        <td><?php print render($content['field_grant08_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant09_ref']); ?></td>
        <td><?php print render($content['field_grant09_perc']); ?></td>
      </tr>
      <tr>
      <tr>
        <td><?php print render($content['field_grant10_ref']); ?></td>
        <td><?php print render($content['field_grant10_perc']); ?></td>
      </tr>
      <tr>
        <th>Total</th>
